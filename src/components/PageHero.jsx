export default function PageHero({ eyebrow, title, description }) {
  return (
    <section className="relative overflow-hidden bg-[var(--color-dark)] py-20 text-white">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_right,rgba(238,112,32,0.28),transparent_36%)]" />
      <div className="absolute inset-x-0 bottom-0 h-1 bg-[var(--color-primary)]" />
